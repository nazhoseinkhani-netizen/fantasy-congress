...
**Domain:** Fantasy sports web app with financial data visualization, gamification, static deployment
**Researched:** 2026-03-23
**Confidence:** HIGH (core framework, styling, state), MEDIUM (charting, animation)
...
```bash
# Bootstrap
npx create-next-app@latest fantasy-congress --typescript --tailwind --eslint --app --src-dir
...
**If deploying as fully static (Vercel/Netlify static hosting, no server functions):**
...
**If Alva Skills API requires authenticated server-side calls:**
...
**If share card images need server-side generation for consistent OG previews:**
...
*Stack research for: Fantasy sports web app (Fantasy Congress) with financial data, gamification, dark mode, static deployment*
*Researched: 2026-03-23*
